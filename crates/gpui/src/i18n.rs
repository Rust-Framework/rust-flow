...
pub enum TKey {
    ...
    PanelAddReturn,
    PanelDeleteRow,
    PanelParamNamePlaceholder,
    PanelParamValuePlaceholder,
    PanelComplexFields,
    // 编辑模式
    PanelAdvancedMode,
    PanelRegularMode,
...
fn t_zh(key: TKey) -> &'static str {
    match key {
        ...
        TKey::PanelParamOptional => "可选",
        TKey::PanelParamArray => "数组",
        TKey::PanelAddParam => "+ 添加参数",
        TKey::PanelAddVariable => "+ 添加变量",
        TKey::PanelAddReturn => "+ 添加返回",
        TKey::PanelDeleteRow => "删除",
        TKey::PanelParamNamePlaceholder => "名称",
        TKey::PanelParamValuePlaceholder => "值",
        TKey::PanelComplexFields => "子字段",
        TKey::PanelAdvancedMode => "高级编辑",
        TKey::PanelRegularMode => "常规编辑",
        TKey::PanelFieldEdit => "编辑字段",
        TKey::PanelFieldName => "字段名",
        TKey::PanelFieldType => "字段类型",
        TKey::PanelFieldValue => "字段值",
        TKey::PanelFieldSummary => "摘要",
        TKey::PanelFieldDescription => "描述",
...
fn t_en(key: TKey) -> &'static str {
    match key {
        ...
        TKey::PanelParamOptional => "Optional",
        TKey::PanelParamArray => "Array",
        TKey::PanelAddParam => "+ Add Param",
        TKey::PanelAddVariable => "+ Add Variable",
        TKey::PanelAddReturn => "+ Add Return",
        TKey::PanelDeleteRow => "Delete",
        TKey::PanelParamNamePlaceholder => "name",
        TKey::PanelParamValuePlaceholder => "value",
        TKey::PanelComplexFields => "Sub-fields",
        TKey::PanelAdvancedMode => "Advanced Edit",
        TKey::PanelRegularMode => "Regular Edit",
        TKey::PanelFieldEdit => "Edit Field",
        TKey::PanelFieldName => "Field Name",
        TKey::PanelFieldType => "Field Type",
        TKey::PanelFieldValue => "Field Value",
        TKey::PanelFieldSummary => "Summary",
        TKey::PanelFieldDescription => "Description",
